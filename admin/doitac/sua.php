<?php 
  ...
  $detail_brand=executeQuery($sql,false);
  if(isset($_POST['submit'])){
    ...
    $imageFileType = pathinfo($filename,PATHINFO_EXTENSION);
      ...
      elseif(empty($filename)){
        $update_brand = "UPDATE brands SET name='$brand_name',url = '$link' WHERE id = $id";
        executeQuery($update_brand);
        ...
        if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg"){
          ...
          $update_brand = "UPDATE brands SET name='$brand_name', image = 'public/images/$filename',
         url = '$link' WHERE id = $id";
	        executeQuery($update_brand);
    ...
    <section class="content container-fluid">
      <form style="margin-bottom: 20px;font-family: time new roman"  action="" method="post" enctype="multipart/form-data" class="container-fluid">
          <div class="rows col-lg-6 form-group">
            ...
            <input class="col-3 form-control container-fluid form-control-default" type="text" name="brand_name" id="exampleFormControlFile1" value="<?php echo $detail_brand['name'] ?>">
            <span class="text-danger"><?php if(isset($errName)) echo $errName; ?></span>
            <br>
            <img style="height: 200px;" class="img-thumbnail col-lg-12 form-group" width="385px" alt="Responsive image" src="<?php echo Base_url.$detail_brand['image'] ?>">
            ...
            <br>
            <label>Link</label>
            <input class="col-3 form-control container-fluid form-control-default" type="text" name="link" id="exampleFormControlFile1" value="<?php echo $detail_brand['url'] ?>">
            <span class="text-danger"><?php if(isset($errLink)) echo $errLink; ?></span>
            
            <br>
            <input type="submit" class="ppn col-2 container-fluid btn btn-success btn-sm" value="Sửa" name="submit">
