      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo Base_url.'admin/slider'; ?>"><i class="fa fa-sliders" aria-hidden="true"></i>Slide</a></li>
    ...
    <section class="content container-fluid">
      <table class="table text-center">
        <thead>
          <tr>
              <?php $i=1; ?>
              <th class="col-sm-2" scope="col">STT</th> 
